...
class PerceptronModel(object):
    ...
    def train(self, dataset):
        ...
        "*** YOUR CODE HERE ***"
        """
        Huan luyen tap du doan voi tap gia tri python cho den khi ket qua la dong nhat.
        Update gia tri parameter neu du doan khac voi gia tri python, cho den khi 
        result(bien danh gia do chinh xac) = true toan bo thi ket thuc.
        """
        while True:
            result = True
...
class RegressionModel(object):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.batch_size = 1
        self.m0 = nn.Parameter(1, 64)
        self.b0 = nn.Parameter(1, 64)
        self.m1 = nn.Parameter(64, 1)
        self.b1 = nn.Parameter(1, 1)
        self.params = [self.m0, self.m1, self.b0, self.b1]
    ...
    def run(self, x):
        ...
        first_layer = nn.ReLU(nn.AddBias(xm1, self.b0))
        xm2 = nn.Linear(first_layer, self.m1)
        output_layer = nn.AddBias(xm2, self.b1)
        return output_layer
        ...
        while accuracy < 0.975:
            for x, y in dataset.iterate_once(self.batch_size):
                ...
                for i in range(len(self.params)):
                    self.params[i].update(grad[i], -0.01)
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        self.wf = nn.Parameter(self.hiddendim, self.dim)  # w_final
